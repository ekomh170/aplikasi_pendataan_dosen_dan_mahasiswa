...
while($d = mysqli_fetch_array($data)){
	...
	<div class="container m-5">
		<div class="h1 font-weight-bold text-white">Ubah Data Dosen</div>
		<form action="proses/prosesubah.php" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<div class="col-9">
					...
					<input type="name" class="form-control" id="nama_dosen" name="nama_dosen" value="<?= $d['nama_dosen'] ?>" placeholder="Masukan Nama Dosen">
				</div>
			</div>
			<div class="form-group">
				<div class="col-9">
			...
			<div class="form-group">
				<div class="col-9">
					...
					<input type="name" class="form-control" id="nama_matkul" name="nama_matkul" value="<?= $d['nama_matkul'] ?>" placeholder="Masukan Mata Kuliah">
				</div>
			</div>
			<div class="form-group">
				<div class="col-9">
			...
			<div class="form-group">
				<div class="col-9">
					...
					<input type="number" class="form-control" id="no_telp" name="no_telp" value="<?= $d['no_telp'] ?>" placeholder="Masukan Nomer Telepon">
				</div>
			</div>
			<div class="form-group">
				<div class="col-9">
