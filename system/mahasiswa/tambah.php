	...
	<form action="proses/prosestambah.php" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<div class="col-9">
				...
				<input type="name" class="form-control" id="nama_jurusan" name="nama_jurusan" placeholder="Masukan Nama Jurusan">
			</div>
		</div>
		<div class="form-group">
			<div class="col-9">
				<label for="nama_tahun_akademik" class="font-weight-bold text-danger">Nama Tahun Akademik : </label>
				<input type="name" class="form-control" id="nama_tahun_akademik" name="nama_tahun_akademik" placeholder="Masukan Nama Tahun Akademik">
			</div>
		</div>
		<div class="form-group">
			<div class="col-9">
		...
		<div class="form-group">
			<div class="col-9">
				...
				<input type="name" class="form-control" id="no_telp" name="no_telp" placeholder="Masukan Nomor Telepon">
			</div>
		</div>
		<div class="form-group">
			<div class="col-9">
